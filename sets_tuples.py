...
# # #You cannot acces elements in a set ny index because sets are unordered
# # #Instead you canconvert the set to a list and access elements by index
# # list1 = list(set1)
# # print(list1[0]) # Output 1
# # #we use sets when we want to store unique elements
# # #and we don't care about the order of elements
# # #and d0o not want the elemenets to be changed

# # # add elements to a set
# # print(set1.add(6)) # Output; {1,2,3,4,5,6}
# # print(set2.add('orange')) # Output: {'apple, 'banana'}
# # print(set3.add("kiwi"))
# # #remove elements from a set
# # print(set1.remove(6)) # Output: {1,2,3,4,5,6]
# # print(set2.remove('orange')) # Output: {'apple}
...
# # print(list(tuple1)) # Outout [1,2,3,4,5]
...
hr_budget = 50000
engineering_budget = 120000
total = hr_budget + engineering_budget
print(total)
